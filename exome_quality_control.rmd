...
# define a function called 'calculate_metrics' to calculate quality metrics from vcf files. The input 
# parameter should be the file path to the vcf (without the extension)
#calculate_qual_metrics() {
...
#calculate_qual_metrics $PREFIX.autosomes
...
# Create a new environment variable. This variable will hold everything related to
# the data before QC
pre_QC <- new.env()
...
# ldepth.mean = read.delim((paste0(PREFIX,".autosomes.DP",DP_autosomes,".GQ",GQ_autosomes,".ldepth.mean")), header = T, sep = "")
# 
# ### Get basic stats
# depth_site = describe(ldepth.mean$MEAN_DEPTH)
# rownames(depth_site) = c("site_mean_depth")

...
print(paste("Mean heterozygosity -3 Standard Deviations =", heterozygosity_low_limit))

## High threshold
heterozygosity_high_limit = mean(het$F)+(3*(sd(het$F)))
print(paste("Mean heterozygosity +3 Standard Deviations =", heterozygosity_high_limit))
